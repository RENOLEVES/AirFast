...
public class EmployeeController {
    ...
    // CREATE
    @PostMapping
    public ResponseEntity<EmployeeResponse> create(@RequestBody ManagerRequestDTO request) {
        final EmployeeResponse created = employeeService.createEmployee(request);
