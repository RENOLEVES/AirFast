...
public class OwnerResponse extends PersonResponse {
    ...
    public OwnerResponse(Long id, String email, String firstName, String lastName) {
        super(id, email,firstName,lastName,"Owner");
    }
