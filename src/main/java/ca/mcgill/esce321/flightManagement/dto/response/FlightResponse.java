...
public class FlightResponse {
    ...
    public FlightResponse(Long long1, int i, int j, LocalDateTime localDateTime, LocalDateTime localDateTime2, LocalDateTime localDateTime3, String string, String string2, String string3, double d, boolean b, boolean c) {}

    public FlightResponse(Long flightId, int capacity, int seatsRemaining,
                          Integer delayHours,
    ...
    public FlightResponse(Long flightId, int capacity,
